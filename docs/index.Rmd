...
- Arguments can be any type (numeric, character, etc.)
- Unlike other languages, function definitions don't specify input types
- To avoid unwanted behavior, you can check or convert types
```{r}
hyp <- function(side_a, side_b) {
